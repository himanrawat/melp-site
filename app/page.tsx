...
export default function Home() {
	...
	return (
		<div className="p-4 w-full rounded-4xl border-2 border-gray-200 bg-[radial-gradient(circle,rgb(230,230,230)_1px,transparent_1px)] bg-[length:10px_10px] overflow-hidden pt-20 bg-white transition-colors duration-300">
			<div className="flex flex-col h-full justify-center">
				<div className="bg-primary-200 w-fit p-2 rounded-lg mb-4 flex items-center gap-2 mx-auto border border-primary-300">
				...
				<h1 className="md:text-6xl text-2xl font-bold text-center md:w-4/6 w-full mx-auto text-neutral-900 transition-colors duration-300">
					Create together. Communicate clearly. Collaborate seamlessly.
				</h1>
				<p className="md:text-lg text-sm font-medium leading-[23px] text-center tracking-tight max-w-2xl mx-auto w-[95%] mt-9 text-neutral-600 transition-colors duration-300">
				...
				>
					<div ref={joinButtonRef} className="transform-gpu">
						<Button
							variant="outline"
							size="lg"
							className="group border-primary-500 text-primary-500 bg-white hover:bg-primary-50 hover:text-primary-600 transition-all duration-300 shadow-lg hover:shadow-xl"
						>
					...
					<div ref={startButtonRef} className="transform-gpu">
						<Button
							variant="default"
							size="lg"
							className="group bg-primary-500 text-white hover:bg-primary-600 transition-all duration-300 shadow-lg hover:shadow-xl relative overflow-hidden"
						>
							<div className="flex items-center gap-2">
								<span>Get Started</span>
								<ArrowRight className="w-4 h-4 icon-arrow transition-transform duration-300" />
							</div>
							<div className="shimmer absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full" />
						</Button>
					</div>
				</div>
			</div>
